...
<INPUT runat=server id=EndTime_S name=EndTime_S type=text class="Wdate" dataType="Require" msg="登记截止时间不能为空!"  readonly onClick="WdatePicker()">  
	</td>
</tr>
...
<br />
 ...
 <tr>
  ...
  <tr>
    ...
    <INPUT runat=server id=EndTime_D name=EndTime_D type=text class="Wdate" dataType="Require" msg="结束登记时间不能为空!"  readonly onClick="WdatePicker()">
	</td>
 </tr>
  <tr>
